...
class MyWin(QtWidgets.QMainWindow):
    def __init__(self, parent=None):
        ...
        self.ui.docTable.horizontalHeader().resizeSection(0, 250)
        self.ui.docTable.horizontalHeader().resizeSection(1, 120)
        self.ui.docTable.horizontalHeader().resizeSection(2, 140)
        self.ui.docTable.horizontalHeader().resizeSection(3, 120)
        self.ui.docTable.horizontalHeader().resizeSection(4, 120)
        self.ui.docTable.horizontalHeader().resizeSection(5, 100)
        self.ui.docTable.horizontalHeader().resizeSection(6, 100)
